...
def upgrade(migration):
    ...
    # Add social_security_number column to current_employee_audit table
    migration.add_column(
        table_name="current_employee_audit", 
        column_name="social_security_number", 
        datatype="VARCHAR(32) DEFAULT NULL"
    )
...
def downgrade(migration):
    ...
    # Remove social_security_number column from current_employee_audit table
    migration.drop_column("current_employee_audit", "social_security_number")
